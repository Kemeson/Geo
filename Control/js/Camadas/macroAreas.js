...
*/
  ...
  var macroArea2 = L.geoJSON(macro2, {
    color: "#e27a71", weight: 2.2, fillOpacity: 0.2, Opacity: 1,
    onEachFeature: function (geom, layer) {
  ...
  var macroArea3 = L.geoJSON(macro3, {
    color: "#f4ef89", weight: 2.2, fillOpacity: 0.2, Opacity: 1,
    onEachFeature: function (geom, layer) {
  ...
  var macroArea4 = L.geoJSON(macro4, {
    color: "Purple", weight: 2.2, fillOpacity: 0.2, Opacity: 1,
    onEachFeature: function (geom, layer) {
  ...
  var macroArea5 = L.geoJSON(macro5, {
    color: "#6cc19a", weight: 2.2, fillOpacity: 0.2, Opacity: 1,
    onEachFeature: function (geom, layer) {
  ...
  var macroArea6 = L.geoJSON(macro6, {
    color: "#7aa9ef", weight: 2.2, fillOpacity: 0.2, Opacity: 1,
    onEachFeature: function (geom, layer) {
  ...
  var macroArea7 = L.geoJSON(macro7, {
    color: "#f1b2ad", weight: 2.2, fillOpacity: 0.2, Opacity: 1,
    onEachFeature: function (geom, layer) {
  ...
  var macroArea8 = L.geoJSON(macro8, {
    color: "#9a7c72", weight: 2.2, fillOpacity: 0.2, Opacity: 1,
    onEachFeature: function (geom, layer) {
